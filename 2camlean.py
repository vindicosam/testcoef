...
class DualCameraEpipolarTrainer:
    ...
    # These methods should be indented to be part of the DualCameraEpipolarTrainer class
# Make sure to add proper indentation when inserting them into your code
