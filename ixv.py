...
class LidarCameraVisualizer:
    def __init__(self):
        ...
        self.camera_roi_range = 20       # How much above and below to include
    ...
    def update_plot(self, frame):
        ...
        # Get the camera data for lean calculation only, don't visualize the vector
        ...
        # Find where the camera vector intersects with the board - but don't visualize it
        ...
        # IMPORTANT: Don't draw the camera vector - hide it completely
        ...
        if final_tip_position is not None:
            ...
            # Clear score text if we have no position
            if self.score_text:
