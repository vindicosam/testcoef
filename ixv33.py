...
class LidarCameraVisualizer:
    def __init__(self):
        ...
        self.lidar2_rotation = 189.25       # Adjusted angle
        ...
        self.camera_vector_length = 16000     # Vector length in mm
        ...
        self.camera_board_plane_y = 233  # The y-coordinate where the board surface is
    ...
    def measure_tip_angle(self, mask, tip_point):
        ...
        Returns:
            angle: Angle in degrees (90Ãƒâ€šÃ‚Â° = vertical) or None if angle couldn't be calculated
        """
    ...
    def apply_segment_coefficients(self, x, y):
        ...
        # Determine segment number from angle (using offset of 9Ãƒâ€šÃ‚Â° as before)
    ...
    def detect_up_down_lean(self, lidar1_point, lidar2_point):
        ...
        Returns:
            lean_angle: Estimated lean angle in degrees (0Ãƒâ€šÃ‚Â° = vertical, positive = up, negative = down)
    ...
    def update_lean_visualization(self, side_lean_angle, up_down_lean_angle, lean_confidence):
        ...
        if side_lean_angle is not None and up_down_lean_angle is not None:
            ...
            side_lean_rad = np.radians(90 - side_lean_angle)  # 90Ãƒâ€šÃ‚Â° is vertical
    ...
    def update_plot(self, frame):
        ...
        if side_lean_angle is not None:
            side_lean_str = f"{side_lean_angle:.1f}Â°"  # Fixed degree symbol
        else:
            side_lean_str = "N/A"

        if up_down_lean_angle is not None:
            up_down_lean_str = f"{up_down_lean_angle:.1f}Â°"  # Fixed degree symbol
        else:
    ...
    def _calibrate_lidar_rotation(self):
        ...
        print(f"Current LIDAR1 rotation: {self.lidar1_rotation}Ãƒâ€šÃ‚Â°")
        print(f"Current LIDAR2 rotation: {self.lidar2_rotation}Ãƒâ€šÃ‚Â°")
        ...
        while True:
            ...
            try:
                ...
                print(f"Updated LIDAR1 rotation: {self.lidar1_rotation}Ãƒâ€šÃ‚Â°")
                print(f"Updated LIDAR2 rotation: {self.lidar2_rotation}Ãƒâ€šÃ‚Â°")
            except:
